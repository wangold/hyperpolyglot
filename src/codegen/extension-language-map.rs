...
::phf::Map {
    ...
    entries: &[
        ...
        (".syntax", &["YAML"]),
        (".arpa", &["DNS Zone"]),
        (".inc", &["HTML", "Pawn", "Motorola 68K Assembly", "SQL", "SourcePawn", "PHP", "C++", "Assembly", "POV-Ray SDL", "NASL", "Pascal"]),
        (".hql", &["HiveQL"]),
        (".asmx", &["ASP"]),
        (".gn", &["GN"]),
        ...
        (".rktl", &["Racket"]),
        (".ol", &["Jolie"]),
        (".cls", &["TeX", "Apex", "VBA", "OpenEdge ABL", "ObjectScript"]),
        (".pod6", &["Pod 6"]),
        (".gms", &["GAMS"]),
        ...
        (".ronn", &["Markdown"]),
        (".jake", &["JavaScript"]),
        (".fcgi", &["Shell", "PHP", "Perl", "Python", "Lua", "Ruby"]),
        (".arc", &["Arc"]),
        (".udo", &["Csound"]),
        (".csl", &["XML"]),
        (".sexp", &["Common Lisp"]),
        ...
        (".m", &["Mathematica", "Objective-C", "MATLAB", "MUF", "Limbo", "M", "Mercury"]),
        (".nuspec", &["XML"]),
        (".bibtex", &["BibTeX"]),
        (".8xp.txt", &["TI Program"]),
        (".sbt", &["Scala"]),
        ...
        (".sed", &["sed"]),
        (".cabal", &["Cabal Config"]),
        (".sch", &["Scheme", "Eagle", "KiCad Schematic", "XML"]),
        (".d", &["DTrace", "D", "Makefile"]),
        (".adp", &["Tcl"]),
        (".xrl", &["Erlang"]),
        (".cfc", &["ColdFusion CFC"]),
        ...
        (".ncl", &["NCL", "Text", "XML"]),
        (".vshader", &["GLSL"]),
        (".x", &["Linker Script", "DirectX 3D File", "Logos", "RPC"]),
        (".r", &["Rebol", "R"]),
        (".srdf", &["XML"]),
        (".mcmeta", &["JSON"]),
        (".har", &["JSON"]),
